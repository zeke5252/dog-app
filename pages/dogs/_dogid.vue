  ...
  <div class="flex flex-col items-center">
    ...
    <div v-else class="relative w-full md:w-2/3 p-3 pt-0 md:p-0 mb-10">
      <h1 class="text-3xl py-8">
        狗狗編號：<span class="text-yellow-400"> {{ dog.animal_id }} </span>
      </h1>
      <div
        class="flex flex-col gap-3 items-start justify-self-center w-full p-3 md:p-15 mb-5 bg-white shadow-sm"
      >
      ...
      <div>
        <CardInfos
          :is-brief="false"
          :dog="dog"
          :style-title="'cardInfoTitle' + ' py-1 px-2'"
          :style-body="'cardInfoBody' + ' text-sm py-3 px-2'"
          :style-mt="'mt-4'"
        />
      </div>
    </div>
    ...
    return {
      ...
      meta: [
        ...
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          ...
          name: 'description',
          content:
            'Detailed content about the dog where you can add to favorites',
        },
      ],
